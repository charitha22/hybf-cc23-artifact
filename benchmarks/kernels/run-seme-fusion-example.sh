...
mv ".text_substring.dot" $FILE.baseline.dot
...
mv ".text_substring.dot" $FILE.seme-fusion.dot
...
mv ".text_substring.dot" $FILE.cfm.dot
$SIZE $FILE.cfm.o
...
mv ".text_substring.dot" $FILE.hybf.dot
$SIZE $FILE.hybf.o
